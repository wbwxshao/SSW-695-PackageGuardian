...
def checksum(line):
    ...
    try:  # Just to make sure
        ...
        GPIO.setup(14,GPIO.OUT)     #light if GPS is normal
...
def printRMC(lines):
    ...
    print("Magnetic variation: ", lines[10])
    if len(
...
def printGSA(lines):
    ...
    print("PRNs of satellites used for fix:")
    for i in range(0, 12):
...
def printGLL(lines):
    ...
    print("Lat,Long: ", latlng[0], lines[2], ", ", latlng[1], lines[4])
